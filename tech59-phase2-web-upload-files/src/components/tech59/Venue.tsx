...
import venueAvif from "@/assets/venue.avif";
import venueWebp from "@/assets/venue.webp";
        ...
        <Reveal variant="left" className="order-2 lg:order-1">
          ...
          >
            <div className="aspect-[4/3] overflow-hidden">
              <picture>
                <source type="image/avif" srcSet={venueAvif} />
                <source type="image/webp" srcSet={venueWebp} />
                <img
                  src={venueImg}
