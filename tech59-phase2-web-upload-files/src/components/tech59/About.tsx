...
import quoteGregAvif from "@/assets/quote-greg-v3.avif";
import quoteEdwin from "@/assets/quote-edwin-v3.webp";
import quoteEdwinAvif from "@/assets/quote-edwin-v3.avif";
import quoteRui from "@/assets/quote-rui-v3.webp";
import quoteRuiAvif from "@/assets/quote-rui-v3.avif";

const quotes = [
  {
    bg: quoteGreg,
    bgAvif: quoteGregAvif,
    imgClass: "scale-105",
    text: (
      <span>
        ...
        <Reveal variant="scale" delay={120} className="min-w-0">
          <div className="relative glass-strong rounded-3xl p-5 sm:p-6 md:p-8 overflow-hidden grain max-w-full">
            <picture className="absolute inset-0 pointer-events-none">
              <source type="image/avif" srcSet={cur.bgAvif} />
              <source type="image/webp" srcSet={cur.bg} />
              <img
                key={cur.bg}
                src={cur.bg}
                alt=""
                ...
                width={1100}
                height={733}
                className={`w-full h-full object-cover ${cur.imgClass} opacity-30 transition-opacity duration-700 ease-out`}
              />
            </picture>
