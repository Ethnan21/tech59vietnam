...
export const StickyCTA = () => {
  ...
  return (
    <a
      ...
      className={`fixed bottom-6 right-6 z-40 inline-flex items-center gap-2 bg-brand text-primary-foreground font-semibold rounded-full px-6 py-4 shadow-[0_0_50px_hsl(258_90%_66%/0.7)] animate-pulse-glow transition-all duration-500 hover:scale-110 ${
