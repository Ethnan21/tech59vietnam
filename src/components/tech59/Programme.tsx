    ...
    <>
      ...
      <div className="relative flex flex-col md:flex-row md:items-start gap-2 md:gap-5">
        ...
        <div className="flex flex-col min-w-0 flex-1">
          ...
          {s.logo && (
            <div className="relative inline-flex items-center justify-center px-5 md:px-7 h-12 md:h-14 rounded-full glass-strong ring-1 ring-accent/30 shadow-[0_0_20px_hsl(var(--accent)/0.15)]">
              <img
                src={s.logo.src}
                alt={s.logo.alt}
                className="relative h-7 md:h-9 w-auto object-contain"
              />
            </div>
          )}
