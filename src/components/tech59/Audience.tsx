  ...
  return (
    <section id="audience" className="py-24 relative">
      <div className="container">
        ...
        <Reveal delay={200}>
          <div key={cur.key} className="relative glass-strong rounded-3xl p-10 md:p-16 overflow-hidden grain">
            <div className="absolute -top-20 -right-20 w-[400px] h-[400px] rounded-full bg-secondary/20 blur-[120px] animate-pulse-glow" />
            <p className="relative font-display text-4xl md:text-7xl font-bold leading-[0.95] mb-8 max-w-3xl text-gradient-animated animate-fade-in">
              {cur.benefit}
            </p>
            <Button variant="hero" size="lg" asChild className="relative cta-glow">
