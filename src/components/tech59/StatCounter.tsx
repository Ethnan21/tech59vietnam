...
export const StatCounter = ({ end, label, suffix = "+" }: { end: number; label: string; suffix?: string }) => {
  ...
  return (
    <div ref={ref} className="text-center relative group">
      <div className="font-display text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-bold text-gradient-animated text-slate-50 tabular-nums drop-shadow-[0_0_25px_hsl(258_90%_66%/0.5)]">
